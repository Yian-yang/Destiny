package xuan.utils.liuyao;

import com.nlf.calendar.Lunar;
import com.nlf.calendar.Solar;
import xuan.utils.liuyao.maps.LiuYaoJiChuMap;
import xuan.utils.liuyao.settings.LiuYaoJiChuSetting;
import xuan.utils.liuyao.utils.LiuYaoJiChuUtil;
import xuan.utils.liuyao.utils.LiuYaoShenShaUtil;
...
//*******************************************************************************************************************************
    ...
    public LiuYao(LiuYaoJiChuSetting liuYaoJiChuSetting) {
        ...
        // 1、获取日期
        Map<String, Object> date = LiuYaoJiChuUtil.getDate(liuYaoJiChuSetting);
        this.solar = (Solar) date.get("solar"); // 公历日期
        this.lunar = (Lunar) date.get("lunar"); // 农历日期

        // 2、获取干支
        Map<String, List<String>> ganZhi = LiuYaoJiChuUtil.getGanZhi(liuYaoJiChuSetting, this.lunar);
...
//===============================================================================================================================
    ...
    public String getTaiSuiType() {
        ...
        if (this.liuYaoJiChuSetting.getYearGanZhiType() == 0) {
            return LiuYaoJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhi() + this.yearZhi); // 以正月初一起算
        } else if (this.liuYaoJiChuSetting.getYearGanZhiType() == 1) {
            LiuYaoJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhiByLiChun() + this.yearZhi); // 以立春当天起算
        } else if (this.liuYaoJiChuSetting.getYearGanZhiType() == 2) {
            LiuYaoJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhiExact() + this.yearZhi); // 以立春交接时刻起算
        }

        return LiuYaoJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhi() + this.yearZhi);
    ...
    public String getPrevJie() {
        return getLunar().getPrevJie(this.liuYaoJiChuSetting.getJieQiType() == 0).toString();
    }
    ...
    public String getPrevJieDateStr() {
        return getLunar().getPrevJie(this.liuYaoJiChuSetting.getJieQiType() == 0).getSolar().toYmdHms();
    }
    ...
    public String getNextJie() {
        return getLunar().getNextJie(this.liuYaoJiChuSetting.getJieQiType() == 0).toString();
    }
    ...
    public String getNextJieDateStr() {
        return getLunar().getNextJie(this.liuYaoJiChuSetting.getJieQiType() == 0).getSolar().toYmdHms();
    }
    ...
    public String getPrevQi() {
        return getLunar().getPrevQi(this.liuYaoJiChuSetting.getJieQiType() == 0).toString();
    }
    ...
    public String getPrevQiDateStr() {
        return getLunar().getPrevQi(this.liuYaoJiChuSetting.getJieQiType() == 0).getSolar().toYmdHms();
    }
    ...
    public String getNextQi() {
        return getLunar().getNextQi(this.liuYaoJiChuSetting.getJieQiType() == 0).toString();
    }
    ...
    public String getNextQiDateStr() {
        return getLunar().getNextQi(this.liuYaoJiChuSetting.getJieQiType() == 0).getSolar().toYmdHms();
    }
    ...
    public Map<String, String> getShenSha() {
        ...
        LiuYaoShenShaUtil liuYaoShenShaUtil = new LiuYaoShenShaUtil(this.yearGanZhi, this.monthGanZhi, this.dayGanZhi, this.hourGanZhi);
     ...
     * @return 六爻爻象标识（如：[○, ×, , ×, , ]）
     */
    public List<String> getLiuYaoAsMark() {
        return this.liuYaoAsMark;
    }

...
//****************************************************************************************************************************************************
     ...
     *
     * @param solar 公历日期
     * @return 公历日期（格式：yyyy年MM月dd日HH时mm分ss秒）
     */
     ...
     *
     * @param lunar 农历日期
     * @return 农历日期（格式：yyyy年MM月dd日HH时mm分ss秒）
     */
    ...
    /**
     * 获取字符串型日期（格式：yyyy-MM-dd HH:mm:ss）
     *
     * @param date   Date型日期
     * @return 字符串型日期（格式：yyyy-MM-dd HH:mm:ss）
     */
     ...
     * @param iSecond 要增加或减少的秒数
     */
    public static Date updateDate(Date date, int iMinute, int iSecond) {
     ...
     * @return 日期字符串
     */
    public static String getDateStr2(int year, int month, int day, int time, int minute, int second) {

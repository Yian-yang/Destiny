...
import xuan.utils.bazi.maps.BaZiDaYunLiuNianMap;
...
//****************************************************************************************************************************************************
     ...
     */
    public BaZiDaYunLiuNianUtil(Date solarDate, int sex, int qiYunLiuPaiType, int yearGanZhiType, int monthGanZhiType, int dayGanZhiType) {
...
//====================================================================================================================================================
     ...
     * @return 大运（干支、天干十神、地支十神、自坐、星运、公历日期、公历年、年龄、藏干、副星、空亡、纳音、神煞）
     */
     ...
     * @return 流年（干支、天干十神、地支十神、自坐、星运、公历日期、公历年、年龄、藏干、副星、空亡、纳音、神煞）
     */
     ...
     * @param daYunLunShu 一共需要计算多少轮大运
     * @param daYunLun    第几轮大运
     * @return 小运（干支、天干十神、地支十神、自坐、星运、公历日期、公历年、年龄、藏干、副星、空亡、纳音、神煞）
     */
     ...
     * @param daYunLunShu 一共需要计算多少轮大运
     * @param daYunLun    第几轮大运
     * @param liuNianLun  第几轮流年
     * @param solarYear   公历年
     * @return 流月（干支、天干十神、地支十神、自坐、星运、公历日期、公历几月几日、十二节、藏干、副星、空亡、纳音、神煞）
     */
     ...
     * @return 流日（干支、天干十神、地支十神、自坐、星运、公历日期、公历日、农历日、藏干、副星、空亡、纳音、神煞）
     */
     ...
     * @param solarMonth 公历月
     * @param solarDay   公历日
     * @return 流时（干支、天干十神、地支十神、自坐、星运、公历日期、公历时、汉代命名、藏干、副星、空亡、纳音、神煞）
     */
    ...
    public String getYearGan() {
        return this.yearGanZhi.substring(0, 1);
    }
    ...
    public String getMonthGan() {
        return this.monthGanZhi.substring(0, 1);
    }
    ...
    public String getDayGan() {
        return this.dayGanZhi.substring(0, 1);
    }
    ...
    public String getHourGan() {
        return this.hourGanZhi.substring(0, 1);
    }
    ...
    public String getYearZhi() {
        return this.yearGanZhi.substring(1, 2);
    }
    ...
    public String getMonthZhi() {
        return this.monthGanZhi.substring(1, 2);
    }
    ...
    public String getDayZhi() {
        return this.dayGanZhi.substring(1, 2);
    }
    ...
    public String getHourZhi() {
        return this.hourGanZhi.substring(1, 2);
    }
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    private void initializeDaYun(int daYunLunShu) {
        ...
        for (DaYun dy : daYunSource) {
            ...
            if (StringUtils.isNotBlank(ganZhi)) {
                List<String> shiShen = computeShiShen(ganZhi);
                ganShen = shiShen.get(0); // 天干十神
                zhiShen = shiShen.get(1); // 地支十神
                ziZuo = shiErZhangShengMap.get(ganZhi); // 自坐
                xingYun = shiErZhangShengMap.get(this.dayGan + ganZhi.charAt(1)); // 星运
                List<String> cangGanList = diZhiCangGanMap.get(ganZhi.substring(1, 2)); // 藏干集合
                ...
                BaZiShenShaUtil shenShaUtil = new BaZiShenShaUtil(this.sex, this.jiJie, this.yearGanZhiNaYinWuXing, this.yearGanZhi, this.monthGanZhi, this.dayGanZhi, this.hourGanZhi, ganZhi, CommonUtil.EMPTY2, CommonUtil.EMPTY2, CommonUtil.EMPTY2, CommonUtil.EMPTY2);
                shenSha = String.join(CommonUtil.EMPTY1, shenShaUtil.getDaYunGanZhiShenSha()); // 大运干支神煞
            }
            String solarDate = DateUtil.getDateStr2(dy.getStartYear(), 1, 1, 0, 0, 0); // 公历日期
            daYun.add(Arrays.asList(ganZhi, ganShen, zhiShen, ziZuo, xingYun, solarDate, String.valueOf(dy.getStartYear()), String.valueOf(dy.getStartAge()), cangGan, fuXing, kongWang, naYin, shenSha)); // 干支、天干十神、地支十神、自坐、星运、公历日期、公历年、年龄、藏干、副星、空亡、纳音、神煞
        }

        // 2、计算并设置小运持续的年数（根据公历年计算）
        this.xiaoYunYearSum = Integer.parseInt(daYun.get(1).get(6)) - Integer.parseInt(daYun.get(0).get(6));

        // 3、处理第一轮大运的年龄数据
        if (this.xiaoYunYearSum < 1) {
            // 3.1、若小运持续年数小于1年，则将大运的第一轮数据的岁数重置为：1~10
            daYun.set(0, daYun.get(0)).set(7, "1~10");
        } else if (this.xiaoYunYearSum == 1) {
            // 3.2、若小运持续年数等于1年，则将大运的第一轮数据的岁数重置为：1
            daYun.set(0, daYun.get(0)).set(7, String.valueOf(this.xiaoYunYearSum));
        } else {
            // 3.3、若小运持续年数大于1年，则将大运的第一轮数据的岁数重置为：1~?
            daYun.set(0, daYun.get(0)).set(7, "1~" + this.xiaoYunYearSum);
        }

        // 4、处理全部大运岁数
        for (int i = 1; i < daYun.size() - 1; i++) {
            int startAge = Integer.parseInt(daYun.get(i).get(7));
            int endAge = startAge + 9;
            daYun.set(i, daYun.get(i)).set(7, startAge + "~" + endAge);
        }
    ...
    private void initializeLiuNian(int daYunLun) {
        ...
        for (int i = start; i < end; i++) {
            ...
            if (StringUtils.isNotBlank(ganZhi)) {
                ...
                kongWang = kongWangMap.get(ganZhi); // 空亡
                naYin = naYinMap.get(ganZhi); // 纳音
                BaZiShenShaUtil shenShaUtil = new BaZiShenShaUtil(this.sex, this.jiJie, this.yearGanZhiNaYinWuXing, this.yearGanZhi, this.monthGanZhi, this.dayGanZhi, this.hourGanZhi, CommonUtil.EMPTY2, ganZhi, CommonUtil.EMPTY2, CommonUtil.EMPTY2, CommonUtil.EMPTY2);
                shenSha = String.join(CommonUtil.EMPTY1, shenShaUtil.getLiuNianGanZhiShenSha()); // 流年干支神煞
            }
            String solarDate = DateUtil.getDateStr2(Integer.parseInt(ln.get(1)), 1, 1, 0, 0, 0); // 公历日期
            liuNian.add(Arrays.asList(ganZhi, ganShen, zhiShen, ziZuo, xingYun, solarDate, ln.get(1), ln.get(2), cangGan, fuXing, kongWang, naYin, shenSha)); // 干支、天干十神、地支十神、自坐、星运、公历日期、公历年、年龄、藏干、副星、空亡、纳音、神煞
        }
    ...
    private void initializeXiaoYun(int daYunLun) {
        ...
        for (int i = start; i < end; i++) {
            ...
            if (StringUtils.isNotBlank(ganZhi)) {
                ...
                naYin = naYinMap.get(ganZhi); // 纳音
                BaZiShenShaUtil shenShaUtil = new BaZiShenShaUtil(this.sex, this.jiJie, this.yearGanZhiNaYinWuXing, this.yearGanZhi, this.monthGanZhi, this.dayGanZhi, this.hourGanZhi, CommonUtil.EMPTY2, ganZhi, CommonUtil.EMPTY2, CommonUtil.EMPTY2, CommonUtil.EMPTY2);
                shenSha = String.join(CommonUtil.EMPTY1, shenShaUtil.getLiuNianGanZhiShenSha()); // 流年干支神煞（注：此处直接取流年干支神煞即可）
            }
            String solarDate = DateUtil.getDateStr2(Integer.parseInt(xy.get(1)), 1, 1, 0, 0, 0); // 公历日期
            xiaoYun.add(Arrays.asList(ganZhi, ganShen, zhiShen, ziZuo, xingYun, solarDate, xy.get(1), xy.get(2), cangGan, fuXing, kongWang, naYin, shenSha)); // 干支、天干十神、地支十神、自坐、星运、公历日期、公历年、年龄、藏干、副星、空亡、纳音、神煞
        }
     ...
     * @param solarYear  公历年
     */
    private void initializeLiuYue(int daYunLun, int liuNianLun, int solarYear) {
        ...
        if (daYunLun == 1) {
            if (this.xiaoYunYearSum == 0) {
                // 4.1、第一轮大运，小运持续的年数为0，获取第一轮大运中第一到十二轮流月数据（说明：当起运时间小于1年时才会出现这种情况）  TODO：待修改
                for (int i = 0; i < 12; i++) {
                    ...
                    if (StringUtils.isNotBlank(ganZhi)) {
                        ...
                        kongWang = kongWangMap.get(ganZhi); // 空亡
                        naYin = naYinMap.get(ganZhi); // 纳音
                        BaZiShenShaUtil shenShaUtil = new BaZiShenShaUtil(this.sex, this.jiJie, this.yearGanZhiNaYinWuXing, this.yearGanZhi, this.monthGanZhi, this.dayGanZhi, this.hourGanZhi, CommonUtil.EMPTY2, CommonUtil.EMPTY2, ganZhi, CommonUtil.EMPTY2, CommonUtil.EMPTY2);
                        shenSha = String.join(CommonUtil.EMPTY1, shenShaUtil.getLiuYueGanZhiShenSha()); // 流月干支神煞
                    }
                    if (i == 11) solarYear++;
                    String solarDate = DateUtil.getDateStr2(solarYear, Integer.parseInt(ly.get(1)), 1, 0, 0, 0); // 公历日期
                    liuYue.add(Arrays.asList(ganZhi, ganShen, zhiShen, ziZuo, xingYun, solarDate, ly.get(2), ly.get(3), ly.get(4), cangGan, fuXing, kongWang, naYin, shenSha)); // 干支、天干十神、地支十神、自坐、星运、公历日期、公历几月几日、十二节农历月、十二节、藏干、副星、空亡、纳音、神煞
                }
            } else {
                // 4.2、第一轮大运，小运持续的年数不为0，获取小运的十二轮流月数据
    ...
    private void initializeLiuRi(int solarYear, int solarMonth) {
        ...
        // 2、获取上一节、下一节
        JieQi prevJie = lunar.getPrevJie(true); // 上一节
        JieQi nextJie = lunar.getNextJie(true); // 下一节
        ...
        for (int i = 0; i < 60; i++) {
            ...
            if (!nextLunar.getJie().equals(nextJie.toString())) {
                ...
                if (StringUtils.isNotBlank(ganZhi)) {
                    ...
                    kongWang = kongWangMap.get(ganZhi); // 空亡
                    naYin = naYinMap.get(ganZhi); // 纳音
                    BaZiShenShaUtil shenShaUtil = new BaZiShenShaUtil(this.sex, this.jiJie, this.yearGanZhiNaYinWuXing, this.yearGanZhi, this.monthGanZhi, this.dayGanZhi, this.hourGanZhi, CommonUtil.EMPTY2, CommonUtil.EMPTY2, CommonUtil.EMPTY2, ganZhi, CommonUtil.EMPTY2);
                    shenSha = String.join(CommonUtil.EMPTY1, shenShaUtil.getLiuRiGanZhiShenSha()); // 流日干支神煞
                }
                String solarDate = DateUtil.getDateStr2(nextSolar.getYear(), nextSolar.getMonth(), nextSolar.getDay(), 0, 0, 0); // 公历日期
                liuRi.add(Arrays.asList(ganZhi, ganShen, zhiShen, ziZuo, xingYun, solarDate, nextSolar.getDay() + "日", nextLunar.getDayInChinese(), cangGan, fuXing, kongWang, naYin, shenSha)); // 干支、天干十神、地支十神、自坐、星运、公历日期、公历日、农历日、藏干、副星、空亡、纳音、神煞
            } else break;
        }
    ...
    private void initializeLiuShi(int solarYear, int solarMonth, int solarDay) {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            if (StringUtils.isNotBlank(ganZhi)) {
                ...
                kongWang = kongWangMap.get(ganZhi); // 空亡
                naYin = naYinMap.get(ganZhi); // 纳音
                BaZiShenShaUtil shenShaUtil = new BaZiShenShaUtil(this.sex, this.jiJie, this.yearGanZhiNaYinWuXing, this.yearGanZhi, this.monthGanZhi, this.dayGanZhi, this.hourGanZhi, CommonUtil.EMPTY2, CommonUtil.EMPTY2, CommonUtil.EMPTY2, CommonUtil.EMPTY2, ganZhi);
                shenSha = String.join(CommonUtil.EMPTY1, shenShaUtil.getLiuShiGanZhiShenSha()); // 流时干支神煞
            }
            String solarDate = DateUtil.getDateStr2(solarYear, solarMonth, solarDay, BaZiDaYunLiuNianMap.SHI_ER_SHI_2[i], 0, 0); // 公历日期
            liuShi.add(Arrays.asList(ganZhi, ganShen, zhiShen, ziZuo, xingYun, solarDate, BaZiDaYunLiuNianMap.SHI_ER_SHI[i], BaZiDaYunLiuNianMap.DI_ZHI_HAN_MING[i], cangGan, fuXing, kongWang, naYin, shenSha)); // 干支、天干十神、地支十神、自坐、星运、公历日期、公历时、汉代命名、藏干、副星、空亡、纳音、神煞
            hour += 2;
        }
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
     ...
     * @return 十神（天干十神、地支十神）
     */
    protected List<String> computeShiShen(String ganZhi) {
        ...
        String ganShiShen = shiShenMap.get(this.dayGan + gan); // 天干十神
        String zhiShiShen = shiShenMap.get(this.dayGan + zhi); // 地支十神

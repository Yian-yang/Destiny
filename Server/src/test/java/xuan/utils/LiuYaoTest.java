...
public class LiuYaoTest {
    ...
    public void liuYaoTest() {
        ...
        liuYaoJiChuSetting.setDate(new Date(2024 - 1900, 1 - 1, 1, 0, 0, 0)); // 日期
        liuYaoJiChuSetting.setDateType(0); // 日期类型（0:公历。1:农历）
        liuYaoJiChuSetting.setLeapMonthType(0); // 闰月类型（0:不使用闰月。1:使用闰月）
        liuYaoJiChuSetting.setJieQiType(1); //  节气类型（0:按天计算。1:按分钟计算）
        liuYaoJiChuSetting.setPaiPanType(0); // 排盘类型（0:日期。1:自动。2:手动）
        liuYaoJiChuSetting.setLiuYao(2); // 上爻(六爻)→ 0:—（2正1背） 1:- -（1正2背） 2:— ○（0正3背） 3:- - ×（3正0背）
        liuYaoJiChuSetting.setWuYao(0);  // 五爻→ 0:—（2正1背） 1:- -（1正2背） 2:— ○（0正3背） 3:- - ×（3正0背）
        liuYaoJiChuSetting.setSiYao(0);  // 四爻→ 0:—（2正1背） 1:- -（1正2背） 2:— ○（0正3背） 3:- - ×（3正0背）
        liuYaoJiChuSetting.setSanYao(0); // 三爻→ 0:—（2正1背） 1:- -（1正2背） 2:— ○（0正3背） 3:- - ×（3正0背）
        liuYaoJiChuSetting.setErYao(0);  // 二爻→ 0:—（2正1背） 1:- -（1正2背） 2:— ○（0正3背） 3:- - ×（3正0背）
        liuYaoJiChuSetting.setYiYao(0);  // 初爻(一爻)→ 0:—（2正1背） 1:- -（1正2背） 2:— ○（0正3背） 3:- - ×（3正0背）
        ...
        liuYaoJiChuSetting.setHourGanZhiType(0); // 时干支类型（0:支持早子时和晚子时）


        // 2、初始化
        LiuYao liuYao = new LiuYao(liuYaoJiChuSetting);
        ...
        System.out.println("太岁类型：" + liuYao.getTaiSuiType());
